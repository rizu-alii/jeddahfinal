    ...
    <div className="absolute inset-0 w-full h-full overflow-hidden">
      {heroImages.map((img, idx) => (
        <img
          ...
          src={img.src}
          alt={img.alt}
          className={`absolute inset-0 h-full w-full object-cover transition-opacity duration-700 ${idx === i ? "opacity-100 animate-[zoom_6s_linear]" : "opacity-0"}`}
        />
      ))}
...
const faqDataEn = [
  { q: "How often should I service my air conditioner?", a: "Regular annual maintenance is recommended to ensure optimal performance and energy efficiency." },
  { q: "What can I do if my refrigerator is not cooling properly?", a: "Check the temperature settings, clean the coils, and ensure proper ventilation around the device." },
  { q: "Is it normal for my washing machine to make unusual noises?", a: "Unusual noises may indicate problems with the engine or bearings; consider professional inspection and repair." },
  { q: "Why is my gas stove burner flame uneven or yellow?", a: "An uneven or yellow flame usually means clogged burner ports or incorrect gas to air mixture." },
  { q: "How can I maintain my dryer for optimal performance?", a: "Clean the lint filters regularly, check the vents for any blockages, and ensure proper ventilation to prevent fire hazards." },
  { q: "Can I fix my device myself or do I need to hire a specialist?", a: "While simple tasks such as cleaning can be done independently, complex problems require professional expertise to avoid further damage." },
];
...
function ServiceCard({ img, title, desc, to, delay = 0 }: { img: string; title: string; desc: string; to: string; delay?: number }) {
  ...
  return (
    ...
    >
      <img src={img} alt={title} className="h-56 w-full object-cover transition-transform duration-300 group-hover:scale-110" />
      <div className="p-6 text-center">
        ...
        <span
          className="mt-5 inline-block rounded-lg px-8 py-3 font-bold text-white shadow transition hover:brightness-110"
...
const faqData = [
  {
    ...
    a: "Regular annual maintenance is recommended to ensure optimal performance and energy efficiency.",
  },
  {
    q: "What can I do if my refrigerator is not cooling properly?",
    a: "Check the temperature settings, clean the coils, and ensure proper ventilation around the device.",
  },
  {
    q: "Is it normal for my washing machine to make unusual noises?",
    a: "Unusual noises may indicate problems with the engine or bearings; consider professional inspection and repair.",
  },
  {
    q: "Why is my gas stove burner flame uneven or yellow?",
    a: "An uneven or yellow flame usually means clogged burner ports or incorrect gas to air mixture. This can affect cooking performance and may indicate a safety issue. Professional cleaning and adjustment is recommended.",
  },
  {
    q: "How can I maintain my dryer for optimal performance?",
    a: "Clean the lint filters regularly, check the vents for any blockages, and ensure proper ventilation to prevent fire hazards.",
  },
  {
    q: "Can I fix my device myself or do I need to hire a specialist?",
    a: "While simple tasks such as cleaning can be done independently, complex problems require professional expertise to avoid further damage.",
  },
];
        ...
        <div className="grid items-center gap-10 md:grid-cols-2 md:gap-16">
          <div className="relative mx-auto w-full max-w-md md:max-w-full">
            ...
            <img
              ...
              className="relative z-10 h-[300px] w-full rounded-3xl object-cover shadow-2xl md:h-[400px]"
            />
          </div>
