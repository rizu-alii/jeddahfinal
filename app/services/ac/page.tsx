...
export const metadata: Metadata = {
  title: "تنظيف وتصليح المكيفات في جدة",
  ...
  openGraph: {
    ...
    description: "AC cleaner and AC repair services in Jeddah - Al Jeddah Cooling Center. AC cleaning, AC repair, installation & removal, gas refill, same-day service, 24/7 available in Jeddah. Call 0591801214.",
    url: "https://aljeddahcoolingcenter.com/services/ac",
